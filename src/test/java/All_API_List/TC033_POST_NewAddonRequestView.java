...
public class TC033_POST_NewAddonRequestView extends BaseClass {

    @Test
    public void POSTNewAddonRequestView()
    {
        //Specify base URI
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/service/addon_request/view");
        ...
        System.out.println("total_addon_amount : "+response.jsonPath().getJsonObject("data.total_addon_amount"));
        ...
        try (FileInputStream ip= new FileInputStream(System.getProperty("user.dir")+"./personal.properties"))
        {
            ...
            prop.setProperty("total_addon_amount", String.valueOf(response.jsonPath().<Integer>getJsonObject("data.total_addon_amount")));
            prop.setProperty("new_addon_req_view_status", String.valueOf(response.jsonPath().<Integer>getJsonObject("data.status")));
