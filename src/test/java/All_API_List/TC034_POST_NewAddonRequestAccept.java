...
public class TC034_POST_NewAddonRequestAccept extends BaseClass {

    @Test
    public void POSTNewAddonRequestAccept()
    {
        //Specify base URI
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/service/addon_request/accept");
