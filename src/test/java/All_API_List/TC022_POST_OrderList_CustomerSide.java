...
public class TC022_POST_OrderList_CustomerSide extends BaseClass {

    @Test
    public void POSTOrderListCustomerSide()
    {
        //Specify base URI
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/service/list");
        ...
        try (FileInputStream ip= new FileInputStream(System.getProperty("user.dir")+"./personal.properties"))
        {
            ...
            prop.setProperty("Total_Order_List_Records", String.valueOf(response.jsonPath().<Integer>getJsonObject("data.total_records")));
            prop.setProperty("Order_Status", String.valueOf(response.jsonPath().<Integer>getJsonObject("data.list[0].order_status")));
