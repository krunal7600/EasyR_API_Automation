...
public class TC035_POST_NewAddonRequestReject extends BaseClass {

    @Test
    public void POSTNewAddonRequestReject()
    {
        //Specify base URI
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/service/addon_request/reject");
