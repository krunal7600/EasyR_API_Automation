...
public class TC030_POST_ManageFav extends BaseClass {

    @Test
    public void POSTManageFav()
    {
        //Specify base URI
        ...
        requestParams.put("is_add_remove","2");
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/serviceprovider/managefav");
