...
public class TC054_POST_SuccessPayment extends BaseClass {

    @Test
    public void POSTSuccessPayment()
    {
        //Specify base URI
        ...
        requestParams.put("order_amount","61.88");
        requestParams.put("order_id","61c2e954e6709221a3fcd9c8");
        requestParams.put("reepay_customer_id","cust-0102");
