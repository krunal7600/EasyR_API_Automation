...
public class TC021_GET_RateCardValues extends BaseClass {
    ...
    public void GETRateCardKeys()
    {
        ...
        httpRequest.queryParam("service_id",prop.getProperty("Service_Id"));
        //httpRequest.queryParam("company_id","");
        ...
        //Response object
        Response response = httpRequest.request(Method.GET,"/api/ratecard/general");
