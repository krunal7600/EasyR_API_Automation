...
public class TC043_POST_RedeemReferralCode extends BaseClass {
    ...
    public void POSTChangePassword()
    {
        ...
        requestParams.put("red_Ref_Code","1111");
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/serviceprovider/redeemReferralCode");
