...
public class TC046_GET_AvailabilityStatusChange_OFF extends BaseClass {

    @Test
    public void POSTAvailabilityStatusChange_OFF()
    {
        //Specify base URI
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/availability_status/false");
