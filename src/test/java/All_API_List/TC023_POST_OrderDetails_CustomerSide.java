...
public class TC023_POST_OrderDetails_CustomerSide extends BaseClass {

    @Test
    public void POSTOrderDetailsCustomerSide()
    {
        //Specify base URI
        ...
        try (FileInputStream ip= new FileInputStream(System.getProperty("user.dir")+"./personal.properties"))
        {
            ...
            prop.setProperty("addon_request_id",response.jsonPath().<String>getJsonObject("data.addon_req_id"));
            prop.setProperty("addon_request_by",response.jsonPath().<String>getJsonObject("data.addon_req_by"));
