...
public class TC031_POST_Logout extends BaseClass {
    ...
    public void POSTLogout()
    {
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/logout");
        ...
        //Get Response Value from JSON Body.
        System.out.println("LOGOUT MESSAGE : "+response.jsonPath().getJsonObject("message"));
    }
}
