...
public class TC027_POST_ProviderAcceptOrder extends BaseClass {

    @Test
    public void POSTProviderAcceptOrder()
    {
        //Specify base URI
        ...
        requestParams.put("negotiated_order_date","");
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/service/provider_accept_order");
