...
public class TC046_GET_AvailabilityStatusChange_ON extends BaseClass {

    @Test
    public void POSTAvailabilityStatusChange_ON()
    {
        //Specify base URI
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/availability_status/true");
