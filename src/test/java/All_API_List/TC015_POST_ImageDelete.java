...
public class TC015_POST_ImageDelete extends BaseClass {
    ...
    public void POSTImageDelete()
    {
        ...
        requestParams.put("image",prop.getProperty("Check_List_Uploaded_Image_URL"));
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/service/checklist/image/delete");
        ...
        System.out.println("Image Delete Success Message : "+response.jsonPath().getJsonObject("message"));
