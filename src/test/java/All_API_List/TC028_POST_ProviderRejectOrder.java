...
public class TC028_POST_ProviderRejectOrder extends BaseClass {

    @Test
    public void POSTProviderRejectOrder()
    {
        //Specify base URI
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/service/provider_reject_order");
