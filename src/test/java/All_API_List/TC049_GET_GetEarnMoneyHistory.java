...
public class TC049_GET_GetEarnMoneyHistory extends BaseClass {

    @Test
    public void GETGetEarnMoneyHistory()
    {
        //Specify base URI
        ...
        //Response object
        Response response = httpRequest.request(Method.GET,"/api/get_earn_money_history");
