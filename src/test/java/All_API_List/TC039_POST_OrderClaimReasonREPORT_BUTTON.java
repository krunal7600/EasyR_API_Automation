...
public class TC039_POST_OrderClaimReasonREPORT_BUTTON extends BaseClass {

    @Test
    public void POSTOrderClaimReasonREPORT_BUTTON()
    {
        //Specify base URI
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/claim/reasons");
