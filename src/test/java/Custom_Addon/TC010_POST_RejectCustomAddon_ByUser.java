...
public class TC010_POST_RejectCustomAddon_ByUser extends BaseClass {
    ...
    public void POSTRejectCustomAddon_ByManager()
    {
        ...
        requestParams.put("manager_request_id",prop.getProperty("requester_id"));
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/custom_addon/reject_custom_addon_by_user");
