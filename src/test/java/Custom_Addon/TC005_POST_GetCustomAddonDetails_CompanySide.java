...
public class TC005_POST_GetCustomAddonDetails_CompanySide extends BaseClass {

    @Test
    public void POSTGetCustomAddonDetails_CompanySide()
    {
        //Specify base URI
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/custom_addon/get_custom_addon_details_manager");
