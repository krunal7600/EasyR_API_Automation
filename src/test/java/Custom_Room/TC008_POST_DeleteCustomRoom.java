...
public class TC008_POST_DeleteCustomRoom extends BaseClass {

    @Test
    public void POSTDeleteCustomRoom()
    {
        //Specify base URI
        ...
        //Response object
        Response response = httpRequest.request(Method.POST,"/api/custom_room/delete_custom_room");
